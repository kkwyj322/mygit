...
extern const uint8 		test_chinese1[28][16];
extern const uint8 		test_chinese2[28][16];
extern const uint8 		test_chinese3[14][16];
extern const uint8 		test_chinese4[14][16];
